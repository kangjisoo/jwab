<?php
  ...
  $sql = "create table ".$projectTitle."_".$projectKey."(id char(10), imgPath char(50), title char(20), contents char(100), img1 char(50), img2 char(50), img3 char(50), img4 char(50), img5 char(50), date datetime, no int(10))";
