...
import org.techtown.calender.selection.criteria.WeekDayCriteria;
import org.techtown.calender.selection.criteria.month.CurrentMonthCriteria;
import org.techtown.calender.selection.criteria.month.NextMonthCriteria;
import org.techtown.calender.selection.criteria.month.PreviousMonthCriteria;
...
public class DefaultCalendarActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setSupportActionBar((Toolbar) findViewById(R.id.calendertoolbar));
